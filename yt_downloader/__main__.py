...
def parse_args(args):
    ...
    #TODO dodac cos na sytuacje w ktorej nie dalem zadnego argumentu
    ...
    parser.add_argument("-p", "--playlist", type=str, help="url for the playlist")

    parser.add_argument("-i", "--info", type=str,
                        help="info")

    parser.add_argument("-t", "--target", type=str, help="The output directory for the downloaded stream. "
